...
From the description of the items we can see that the values 1, 2, 3, and 4 occur in the data for these variables. This means that all other responses have correctly been coded as missing `NA`. 
